<%-- 
    Document   : _loginfail
    Created on : 9 gen 2022, 16:22:57
    Author     : LucaRaveri
--%>
        ...
        <div class="container-sm">
            <form class="border rounded p-5" action="j_security_check" method="post" name="loginForm" style="width:40%; margin:auto; margin-top:90px;">
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="text" class="form-control" id="j_username" placeholder="Enter Username" name="j_username" size="20">
                </div>
                <div class="form-group mt-4">
                    <label for="password">Password</label>
                    <input type="password" class="form-control" id="j_password" placeholder="Enter Password" name="j_password" size="20">
                </div>
